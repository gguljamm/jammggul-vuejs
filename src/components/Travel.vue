...
const getData = () => {
  ...
  const dailyQuery = query(collection(db, 'travel'), orderBy('date', 'desc'));
...
.showSlideLeft-enter-active,
.showSlideLeft-leave-active {
  transition: 0.2s ease;
  width: 150px;
  opacity: 1;
}
.showSlideLeft-enter,
.showSlideLeft-leave-to {
  width: 50px;
  opacity: 0.5;
}
